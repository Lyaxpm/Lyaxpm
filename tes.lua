...
-- IMPROVED: Auto Enchant, Performance Mode, Auto Rejoin, WhatsApp Hooked
...
local Config = {
    ...
    Hooked = {
        Enabled = false,
        APIUrl = "http://103.176.79.203:5001/send/image",
        Username = "g:g",
        PhoneNumber = "",
        TargetRarities = {}
    }
...
function Hooked:FormatWhatsAppMessage(fishInfo)
    ...
    -- Build clean message
    local message = "🎣 *NIKZZ SCRIPT FISH IT V1*\n"
...
local function CreateUI()
    ...
    Tab9:CreateInput({
        Name = "Phone Number",
        PlaceholderText = "6285730882379 (without +)",
        RemoveTextAfterFocusLost = false,
    ...
    Tab9:CreateLabel("Format: 6285730882379 (tanpa +)")
    ...
    print("  • WhatsApp Hooked Notifications")
